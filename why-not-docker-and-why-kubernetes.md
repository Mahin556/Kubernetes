### References:-
- [Day 6: Hello Kubernetes! ? What is Kubernetes?](https://www.youtube.com/watch?v=2xNR2I0Jk-I&ab_channel=CloudWithVarJosh)
...
- **Self-Healing**: 
    * Docker does not have inherent self-healing capabilities to restart failed containers or maintain application stability automatically, unlike Kubernetes.
    * Containers are ephemeral — they can easily go down or stop.
    * If a container dies, you have to recreate it manually or write complex scripts.
...
* Kubernetes (K8s) solves these problems:
    ...
    * It can run, manage, heal, and scale containerized applications automatically.
    * But remember: Kubernetes isn’t always the right solution — it’s complex and overkill for small apps.
